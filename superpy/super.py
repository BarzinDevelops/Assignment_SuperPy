...
import pandas as pd
from rich import print  # Import 'print' function from Rich for better output formatting
...
def main():
    ...
    report_parser.add_argument('report_type', choices=['inventory', 'revenue', 'profit', 'expired'], metavar='report_type', type=str, help="Choose what kind of report you want")
